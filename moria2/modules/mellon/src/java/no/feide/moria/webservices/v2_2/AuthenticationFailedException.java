...
public class AuthenticationFailedException  extends no.feide.moria.servlet.soap.ClientException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://v2_2.webservices.moria.feide.no", "AuthenticationFailedException"));
    }
