 ...
 */
public class Moria1DemoServlet
extends HttpServlet {
    ...
    public final void doGet(final HttpServletRequest request,
        ...
        try {
            ...
            // Prepare API.
            System.setProperty(Moria.SERVICE_ENDPOINT_PROPERTY, config.getProperty(CONFIG_SERVICE_ENDPOINT));
            System.setProperty(Moria.CLIENT_USERNAME, config.getProperty(CONFIG_MASTER_USERNAME));
            System.setProperty(Moria.CLIENT_PASSWORD, config.getProperty(CONFIG_MASTER_PASSWORD));
            Moria service = Moria.getInstance();
            ...
            if (ticket == null) {
                ...
                String redirectURL = service.requestSession(convert(config.getProperty(CONFIG_MASTER_ATTRIBUTE_REQUEST)), request.getRequestURL().toString() + "?" + PARAM_TICKET + "=", "", false);
                ...
                HashMap attributes = service.getAttributes(ticket);
                ...
                while (i.hasNext()) {
                    ...
                    String[] values = (String[]) attributes.get(name);
            ...
            System.err.println("MoriaException caugth: " + e);
