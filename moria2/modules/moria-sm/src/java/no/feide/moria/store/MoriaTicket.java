...
public final class MoriaTicket implements Serializable {
     ...
     */
    public MoriaTicket(final int ticketType, final String servicePrincipal, final long timeToLive) throws IllegalArgumentException,
     ...
     */
    public MoriaTicket(String ticketId, int ticketType, String servicePrincipal, long timeToLive) throws IllegalArgumentException,
            InvalidTicketException {
