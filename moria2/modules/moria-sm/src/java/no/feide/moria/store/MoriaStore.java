...
public interface MoriaStore {
     ...
     * 
     * @param requestAttributes the user attributes the requesting service asks
     *            for
     * @param responseURLPrefix the forward part of the url the client is to be
     *            redirected to
     * @param responseURLPostfix the end part of the url the client is to be
     *            redirected to
     * @param servicePrincipal the name of the service doing the request
     * @param forceInteractiveAuthentication if the user should be forced to
     *            login interactivly. I.e. disable support for single sign-on
     ...
     * 
     * @param loginTicket the ticket from the incoming client request
     * @param keep if true the authnAttempt and ticket will be kept in the
     *            store after this operation
     * @return the MoriaAuthnAttempt assosiated with the ticket
     * @throws InvalidTicketException if the incoming ticket is not a login
     *             ticket
     */
     ...
     * 
     * @param attributes the attribute map to be cached
     ...
     * 
     * @param ticket a ticket to identify a userdata object
     * @return a clone of the object containing the userdata
     * @throws InvalidTicketException thrown if the incoming ticket is not of
     *             the correct type or has an invalid principal
     */
     ...
     * 
     * @param loginTicket the login ticket assosiated with an authentication
     *            attempt
     ...
     * 
     * @param ssoTicket a sso ticket that's already assosiated with a cached
     *            userdata object
     ...
     * @throws InvalidTicketException thrown if the argument ticket is not a
     *             SSO-ticket or has an invalid principal
     */
     ...
     * 
     * @param tgTicket a TGT issued earlier to a service
     * @param servicePrincipal the id of the service that will use the proxy
     *            ticket
     * @return proxy ticket that may be used by the requesting service
     * @throws InvalidTicketException thrown if the incoming ticket is not a
     *             TGT or has an invalid principal
     */
