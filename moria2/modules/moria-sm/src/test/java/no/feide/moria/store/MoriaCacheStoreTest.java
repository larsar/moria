...
public class MoriaCacheStoreTest extends TestCase {
    ...
    public void testCreateAuthnAttempt() throws InvalidTicketException {
        ...
        MoriaTicket loginTicket = store.createAuthnAttempt(attributes, prefix, postfix, principal, forceAuthn);
    ...
    public void testServiceTicketCreation() throws InvalidTicketException {
        ...
        assertEquals("Service ticket has wrong type", MoriaTicket.SERVICE_TICKET, serviceTicket.getTicketType());
    }
    ...
    public void testProxyTicketCreation() throws InvalidTicketException {
        ...
        assertEquals("Userdata for TGT and Proxy ticket do not match", store.getUserData(tgTicket), store.getUserData(proxyTicket));
    }
