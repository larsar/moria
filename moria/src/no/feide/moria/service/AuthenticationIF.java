...
public interface AuthenticationIF extends Remote {
    ...
    public SessionDescriptor requestSession(String[] attributes, String url) throws RemoteException;
    public SessionDescriptor requestSession(String url) throws RemoteException;
