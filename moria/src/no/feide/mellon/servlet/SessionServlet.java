    ...
    throws IOException, ServletException
    {
		...
		throw new ServletException("Neither URL or ID included in request query: "+request.getQueryString());
            ...
            if (request.getParameter("id") == null) { 
                ...
                // postfix.
                String redirectURL = moria.requestSession(new String[] {"cn", "uid"}, request.getParameter("url"), null);
                ...
                log.info("Redirect to Moria: "+redirectURL);
                return;  // We're done.
		...
		String id = request.getParameter("id");
                ...
                HashMap attributes = moria.getAttributes(id);
